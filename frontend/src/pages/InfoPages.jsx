...
const steps = [
  ...
  { num: '06', title: 'Нормализация', desc: 'Взвешенная сумма компонентов нормализуется через сигмоидную функцию, превращая сырые баллы в оценку от 0 до 1. Это делает интерпретацию интуитивной.', icon: BarChart3 },
...
const principles = [
  ...
  { icon: Eye, title: 'Прозрачность', desc: 'Каждый может посмотреть свои данные и результаты анализа. 7-компонентная модель и веса полностью открыты и задокументированы в нашем исследовании.' },
