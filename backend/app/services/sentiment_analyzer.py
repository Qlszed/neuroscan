...
class SentimentAnalyzer:
    ...
    def _fallback_sentiment(self, text: str) -> Dict[str, float]:
        negative_words = ['плохо', 'устал', 'не могу', 'трудно', 'стресс', 'депрессия',
                          ...
                          'измотан', 'обессилен', 'опустошён', 'раздавлен', 'без сил',
                          'всё надоело', 'нет сил', 'не выдержу', 'слишком трудно',
                          'exhausted', 'overwhelmed', 'cant sleep', 'panic', 'stress',
                          'tired', 'depressed', 'anxious', 'hate school', 'school exhausting',
                          'cant focus', 'no energy', 'burnout',
                          ]
